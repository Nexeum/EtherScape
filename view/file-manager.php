...
$active1 = "order-tabs__link--active";
...
<body class="sidebar-collapse">
                                    ...
                                    <div class="toolbox__left-row row row--xs gutter-bottom-xs">
                                        <div class="form-group form-group--inline col col-sm-auto">
                                            <div class="input-group input-group--white input-group--prepend input-group--append">
                                                <button class="button button--primary header__toggle-language" data-toggle="dropdown">
                                                    <span class="button__icon button__icon--left">
                                                        <svg class="icon-icon-plus text-white">
                                                ...
                                                <div class="lang-menu dropdown-menu">
                                                    <a class="lang-menu__button dropdown-menu__item" data-dismiss="modal" data-modal="#addFolder" href="#" tabindex="0">
                                                    ...
                                                    <a class="lang-menu__button dropdown-menu__item" data-dismiss="modal" data-modal="#uploadFile" href="#" tabindex="0">
                                                        <span class="profile-dropdown__icon">
                        ...
                        <?php if (($files) && (mysqli_num_rows($files) > 0)) : ?>
                            ...
                            <div class="table-wrapper tab-content">
                                <div class="tab-pane fade" id="tab-grid">
                                    <div class="file-manager__table table-wrapper__content scrollbar-thin scrollbar-visible" data-simplebar>
                                                ...
                                                <?php foreach ($files as $file) : ?>
                                                    <tr class="table__row">
                                                        ...
                                                        <td class="table__td text-grey text-uppercase">
                                                            <?php
                                                            $url = "../temp/" . $file['user_id'] . "/" . $file['filename'];
                                                            ...
                                                            if (!$file['is_folder']) {
                                                                ...
                                                                $id = $file['id'];
                                                                $sizes = mysqli_query($con, "SELECT * from file where folder_id=$id");
                                                                $sumsize = 0;
                                                                foreach ($sizes as $size) :
                                                                    $url = "../temp/" . $size['user_id'] . "/" . $size['filename'];
                                                                    if (file_exists($url)) {
                                                                        $fsize = filesize($url);
                                                                        if ($size['filename'] != "") {
                                                                            if (!$size['is_folder']) {
                                                                ...
                                                                <div class="dropdown-items dropdown-items--right">
                                                                    <div class="dropdown-items__container">
                                                                        <ul class="dropdown-items__list">
                                                                            ...
                                                                            <li class="dropdown-items__item">
                                                                                <a href="../controller/deltrash.php?id=<?php echo $file['code']; ?>&tkn=<?php echo $_SESSION["tkn"] ?>" class="dropdown-items__link">
                                                                                    <span class="dropdown-items__link-icon">
                                ...
                                if (isset($_GET['folder'])) {
                                    $fcode = $_GET['folder'];
                                    $f = mysqli_query($con, "select * from file where code=\"$fcode\"");

                                    while ($row = mysqli_fetch_array($f)) {
                                        $f_id = $row['id'];
                                    }
                                    $sql = "SELECT * FROM file WHERE user_id = $my_user_id AND is_folder = 1 AND folder_id = $f_id order by created_at desc";
                                } else {
                                    $sql = "SELECT * FROM file WHERE user_id = $my_user_id AND is_folder = 1 AND folder_id is NULL order by created_at desc";
                                }
                                ...
                                <div class="tab-pane active" id="tab-list">
                                                    ...
                                                    <?php if ($file['is_folder']) : ?>
                                                        <div class="files-card">
                                                            <div class="files-card__content">
                                                                ...
                                                                <a href="file-manager.php?folder=<?php echo $file['code']; ?>">
                                    ...
                                    if (isset($_GET['folder'])) {
                                        ...
                                        $fileq = mysqli_query($con, "select * from file where code=\"$filecode\"");

                                        while ($row = mysqli_fetch_array($fileq)) {
                                            $file_id = $row['id'];
                                        }
                                        $sql = "SELECT * FROM file WHERE user_id = $my_user_id AND is_folder = 0 AND folder_id = $file_id order by created_at desc";
                                    } else {
                                        $sql = "SELECT * FROM file WHERE user_id = $my_user_id AND is_folder = 0 AND folder_id is NULL order by created_at desc";
                                    }
                            ...
                            <div class="table-wrapper tab-content">
                                <div class="files-card">
                                    <div class="files-card__content" style="align-items:center;">
                                        <img src="../assets/img/content/main.webp" width="768" alt="">
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
    ...
    <div class="inbox-add modal modal-compact scrollbar-thin" id="uploadFile" data-simplebar>
        ...
        <div class="modal__wrap">
            <div class="modal__window">
                <div class="modal__content">
                    ...
                    <form action="../controller/upfile.php" method="post" enctype="multipart/form-data">
                        <div class="modal__body">
                            <div class="modal__container">
                                <div class="row">
                                    <div class="col-12 form-group form-group--lg mb-0">
                                        <div class="files-upload">
                                            <input type="hidden" name="folder_code" value="<?php echo substr($_SERVER['REQUEST_URI'], 36); ?>" />
    ...
    <div class="inbox-add modal modal-compact scrollbar-thin" id="addFolder" data-simplebar>
        <div class="modal__overlay" data-dismiss="modal"></div>
        <div class="modal__wrap">
            <div class="modal__window">
                <div class="modal__content">
                    ...
                    <div class="modal__header">
                        <div class="modal__container">
                            <h2 class="modal__title">Create Folder</h2>
                        </div>
                    </div>
                    <form action="../controller/newfolder.php" method="POST">
                        <div class="modal__body">
                            <div class="modal__container">
                                <div class="row">
                                    <div class="col-12 form-group form-group--lg mb-0">
                                        <input type="hidden" name="folder_code" value="<?php echo substr($_SERVER['REQUEST_URI'], 36); ?>" />
                                        <label>
                                            <input class="input" type="text" name="filename" value="Untitled folder">
                                        </label>
                                    </div>
                                </div>
                            </div>
